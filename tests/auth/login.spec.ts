...
test.describe('Login Page', () => {
    let loginPage: LoginPage;
                ...
                test('shows login form on /users/sign_in', async () => {
                ...
                test('redirects to sign_in when accessing protected page unauthenticated', async ({ page }) => {
                      await page.goto('/conveyances');
                      // Should be redirected to login
                         await expect(page).toHaveURL(/sign_in/);
                });

                test('redirects to sign_in when accessing enquiries unauthenticated', async ({ page }) => {
